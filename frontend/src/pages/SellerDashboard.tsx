...
const SellerDashboard = () => {
  ...
  const checkShareLockStatus = useCallback(async () => {
    try {
  ...
  const loadProperties = useCallback(async (customFilters = null) => {
    try {
      const filtersToUse = customFilters || propertyFiltersRef.current;
      const cleanFilters = {};
  ...
  }, [user, checkDailyStatus, checkShareLockStatus, loadDashboard]);
  ...
  }, [activeTab, loadCommissions, loadFollowups, loadProperties, loadReferrals, loadVisits]);
