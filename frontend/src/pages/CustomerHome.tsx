...
const CustomerHome = () => {
  ...
  const loadProperties = useCallback(async (customFilters = null) => {
    ...
    try {
      ...
      const cleanFilters = {};
      if (filtersToUse.city && filtersToUse.city.trim()) cleanFilters.city = filtersToUse.city.trim();
      if (filtersToUse.min_rent && filtersToUse.min_rent !== '') cleanFilters.min_rent = filtersToUse.min_rent;
      if (filtersToUse.max_rent && filtersToUse.max_rent !== '') cleanFilters.max_rent = filtersToUse.max_rent;
      if (filtersToUse.bhk && filtersToUse.bhk !== '') cleanFilters.bhk = filtersToUse.bhk;
      if (filtersToUse.furnishing && filtersToUse.furnishing !== '') cleanFilters.furnishing = filtersToUse.furnishing;
  ...
  }, [loadActiveAds, loadAppSettings, loadMyBookings]);
